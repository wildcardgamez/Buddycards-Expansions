...
public class AquacultureIntegration {
    public static void init() {
        ...
        BINDER = RegistryHandler.ITEMS.register("buddycard_binder_aquaculture", () -> new BuddycardBinderItem(RegistryHandler.AQUACULTURE_REQUIREMENT, BuddycardsItems.DEFAULT_BINDER_PROPERTIES, RegistryHandler.AQUACULTURE_SET));
        MEDAL = RegistryHandler.ITEMS.register("buddysteel_medal_aquaculture", () -> new BuddysteelSetMedalItem(RegistryHandler.AQUACULTURE_REQUIREMENT, ExtendedMedalTypes.AQUACULTURE_SET, RegistryHandler.AQUACULTURE_SET, BuddycardsItems.DEFAULT_CURIO_PROPERTIES));
